	...
	<section style="Height: 1000px;">	
		...
		if( i % 2 == 0 ){%>
				<tr>	
					...
					<th class="even" id="idd"><a href="Login.jsp"> <% out.println(list.get(i).getPosttitle()); %></a></th>
				...
				<tr>
					...
					<th scope="row" id="idd"><a href="Login.jsp"><% out.println(list.get(i).getPosttitle()); %></a></th>
